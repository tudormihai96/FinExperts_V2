...
export const banks: Bank[] = [
  ...
  },
  {
    ...
    advantages: ["Dobândă de la 5,55% — cea mai mică fixă", "Aplicare online completă", "Smart Mobile Banking", "Până la 250.000 RON"],
  ...
  },
  {
    ...
    badgeColor: "#00A758",
    slug: "garanti-bbva",
    description: "Garanti BBVA România — ofertă 2026: dobândă fixă 4,99%/an, credit EXTRAcash fără garanții, digital banking complet, parte din grupul BBVA.",
    advantages: ["Dobândă fixă 4,99% — cea mai competitivă 2026", "Credit fără garanții până la 250.000 RON", "Digital banking avansat", "Dobândă ipotecar competitivă"],
