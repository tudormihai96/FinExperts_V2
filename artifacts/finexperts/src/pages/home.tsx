...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F6FB]">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-[#E2E8F0]">
            {[
              ...
              <div key={i} className="py-4 sm:py-5 px-3 sm:px-6 text-center">
                <div className="text-xl sm:text-2xl font-bold text-[#0B2E2E]">{stat.value}</div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-10 sm:py-14">
        <div className="mb-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <h2 className="text-2xl md:text-3xl font-bold text-[#0B2E2E]">
              Află rata lunară în câteva secunde.
            </h2>
            <div className="flex gap-2 shrink-0">
              <button
                onClick={() => setActiveType("ipotecar")}
                className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-colors ${activeType === "ipotecar" ? "bg-[#0B2E2E] text-white" : "border border-[#E2E8F0] text-[#64748B] hover:text-[#0B2E2E] bg-white"}`}
              >
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-colors ${activeType === "personal" ? "bg-[#0B2E2E] text-white" : "border border-[#E2E8F0] text-[#64748B] hover:text-[#0B2E2E] bg-white"}`}
              >
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
            <div>
              ...
              <h2 className="text-xl sm:text-3xl font-bold text-[#0B2E2E]">Cele mai bune dobânzi acum.</h2>
            </div>
                ...
                <div key={bank.id} className={`bg-white border rounded-xl p-5 hover:shadow-sm transition-shadow ${idx === 0 ? "border-[#C49A20]" : "border-[#E2E8F0]"}`}>
                  ...
                  <div className="flex items-end justify-between">
                    <div>
                      ...
                      <div className="text-2xl font-bold text-[#0B2E2E]">{rate.toFixed(2)}%</div>
                      <div className="text-xs text-[#64748B]">DAE {dae.toFixed(2)}%</div>
                    </div>
                    <div className="text-right">
                      <div className="text-xs text-[#64748B]">Rată / lună*</div>
                      <div className="text-lg font-bold text-[#0B2E2E]">{Math.round(monthly).toLocaleString("ro-RO")} RON</div>
          ...
          <div className="text-center">
            <Link href="/banci">
              <button className="border border-[#E2E8F0] text-[#0B2E2E] hover:border-[#0B2E2E] font-medium px-6 py-2.5 rounded-xl transition-colors text-sm">
      ...
      {/* ── CUM FUNCȚIONEAZĂ ── */}
      <section className="bg-[#0B2E2E] py-10 sm:py-14">
        <div className="max-w-7xl mx-auto px-4">
      ...
      <section className="bg-[#C49A20] py-10 sm:py-14">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-2xl sm:text-4xl font-bold text-[#0B2E2E] mb-3 sm:mb-4">Gata să obții cel mai bun credit?</h2>
          <p className="text-[#0B2E2E]/70 mb-6 sm:mb-8 text-base sm:text-lg">
            Trimite cererea gratuit și brokerul tău te contactează în maxim 24h cu oferta personalizată.
          </p>
          <div className="flex gap-3 justify-center flex-wrap">
            <Link href="/aplica">
              <button className="bg-[#0B2E2E] hover:bg-[#132846] text-white font-semibold px-6 sm:px-8 py-3 rounded-xl transition-colors flex items-center gap-2 text-sm sm:text-base">
                Aplică acum gratuit <ArrowRight className="h-4 w-4" />
              </button>
            </Link>
            <Link href="/calculator">
              <button className="bg-white text-[#0B2E2E] hover:bg-white/90 font-medium px-6 sm:px-8 py-3 rounded-xl transition-colors text-sm sm:text-base">
                Calculează mai întâi
              </button>
            </Link>
          </div>
          <div className="mt-8 flex items-center justify-center gap-2 text-[#0B2E2E]/60">
            <Phone className="h-4 w-4" />
            <span className="text-sm">Sau sună direct: <a href="tel:0799715101" className="font-semibold text-[#0B2E2E] hover:underline">0799 715 101</a></span>
          </div>
        </div>
      </section>
    </div>
