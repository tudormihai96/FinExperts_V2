...
function StatisticsTab({ applications, insuranceRequests }: { applications: Application[]; insuranceRequests: InsuranceRequest[] }) {
  ...
  const averageAmount = applications.length ? Math.round(totalAmount / applications.length) : 0;
  const approvalRate = applications.length ? Math.round((approved.length / applications.length) * 100) : 0;
    ...
    <div className="bg-white border border-[#E2E8F0] rounded-xl p-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <div className="rounded-lg border border-[#E2E8F0] p-4">
          <div className="text-2xl font-bold text-[#0B2E2E]">{applications.length}</div>
          <div className="text-xs text-[#64748B]">Aplicări totale</div>
        </div>
        <div className="rounded-lg border border-[#E2E8F0] p-4">
          <div className="text-2xl font-bold text-[#0B2E2E]">{pending.length}</div>
          <div className="text-xs text-[#64748B]">În așteptare</div>
        </div>
        <div className="rounded-lg border border-[#E2E8F0] p-4">
          <div className="text-2xl font-bold text-[#0B2E2E]">{approved.length}</div>
          <div className="text-xs text-[#64748B]">Aprobate</div>
        </div>
        <div className="rounded-lg border border-[#E2E8F0] p-4">
          <div className="text-2xl font-bold text-[#0B2E2E]">{insuranceRequests.length}</div>
          <div className="text-xs text-[#64748B]">Asigurări</div>
        </div>
      </div>
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mt-3">
        <div className="rounded-lg border border-[#E2E8F0] p-4">
          <div className="text-2xl font-bold text-[#0B2E2E]">{inReview.length}</div>
          <div className="text-xs text-[#64748B]">În analiză</div>
        </div>
        <div className="rounded-lg border border-[#E2E8F0] p-4">
          <div className="text-2xl font-bold text-[#0B2E2E]">{rejected.length}</div>
          <div className="text-xs text-[#64748B]">Respinse</div>
        </div>
        <div className="rounded-lg border border-[#E2E8F0] p-4">
          <div className="text-2xl font-bold text-[#0B2E2E]">{approvalRate}%</div>
          <div className="text-xs text-[#64748B]">Rată aprobare</div>
        </div>
        <div className="rounded-lg border border-[#E2E8F0] p-4">
          <div className="text-2xl font-bold text-[#0B2E2E]">{Math.round(averageAmount / 1000)}k</div>
          <div className="text-xs text-[#64748B]">Sumă medie</div>
        </div>
      </div>
    </div>
  );
