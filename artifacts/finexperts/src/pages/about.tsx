...
const faq = [
  ...
  { q: "Cât durează aprobarea unui credit?", a: "Creditele de nevoi personale sunt aprobate de majoritatea băncilor în 24-48h. Creditele ipotecare necesită 3-10 zile lucrătoare, în funcție de complexitatea dosarului și de bancă." },
  { q: "Ce este DAE și de ce este important?", a: "DAE (Dobânda Anuală Efectivă) include dobânda nominală + toate comisioanele obligatorii (administrare, analiză, asigurare). Este singurul indicator corect pentru a compara două oferte de credit. O dobândă mică dar cu comisioane mari poate fi mai scumpă decât o dobândă mai mare fără comisioane." },
  { q: "Pot aplica dacă sunt PFA sau am venituri variabile?", a: "Da. Salariat, PFA, antreprenor sau pensionar — alegem împreună soluția potrivită. Anumite bănci (Patria Bank, Libra Internet Bank) au produse special concepute pentru PFA și venituri din activități independente." },
  { q: "Ce documente am nevoie pentru un credit personal?", a: "De regulă: buletin de identitate, adeverință de venit sau fluturași de salariu (ultimele 3 luni), și extras de cont. Unele bănci online (ING, Raiffeisen) pot aproba fără adeverință, doar pe baza extrasului. Îți pregătim noi lista exactă de documente pentru banca aleasă." },
  { q: "Ce documente am nevoie pentru un credit ipotecar?", a: "Pentru ipotecar sunt necesare: documente de identitate, dovada veniturilor (ultimele 3-6 luni), documentele proprietății (extras CF, plan cadastral, act proprietate), evaluare ANEVAR a imobilului și asigurare obligatorie PAD. Noi coordonăm tot procesul de la zero." },
  { q: "Ce înseamnă IRCC și cum influențează rata mea ipotecară?", a: "IRCC (Indicele de Referință pentru Creditele Consumatorilor) este rata de referință calculată trimestrial de BNR pe baza tranzacțiilor interbancare. Rata ta ipotecară variabilă = IRCC + marjă fixă a băncii. În T1 2026, IRCC = 5,58%. O marjă mai mică înseamnă rată lunară mai mică." },
  { q: "Pot refinanța creditul dacă am găsit o ofertă mai bună?", a: "Da, refinanțarea este legală și uneori extrem de avantajoasă. Dacă dobânda actuală e semnificativ mai mare decât ofertele din piață, refinanțarea poate reduce rata lunară cu sute de RON. Calculăm gratuit dacă merită sau nu, ținând cont de costurile de transfer." },
  { q: "Cât costă serviciile FinExperts?", a: "Serviciile de consultanță și intermediere sunt gratuite pentru client. Suntem remunerați de bancă printr-un comision de intermediere, plătit din bugetul de marketing al băncii. Tu primești aceleași condiții sau mai bune decât dacă ai merge direct la bancă." },
  { q: "Ce se întâmplă dacă sunt respins de o bancă?", a: "Un refuz de la o bancă nu înseamnă că ești refuzat de toate. Fiecare bancă are propriile criterii de scoring. Noi cunoaștem profilurile preferate ale fiecărei bănci și te îndrumăm direct către cea cu cea mai mare probabilitate de aprobare, evitând interogările multiple în Biroul de Credit." },
];
  ...
  return (
    ...
    >
      <div className={`p-6 transition-all duration-300 ${hovered ? "opacity-0" : "opacity-100"}`}>
        <div className="w-14 h-14 rounded-full flex items-center justify-center mx-auto mb-4 text-white font-bold text-sm"
      ...
      <div className={`absolute inset-0 p-6 flex flex-col justify-center transition-all duration-300 ${hovered ? "opacity-100" : "opacity-0 pointer-events-none"}`}
        style={{ backgroundColor: member.color }}>
        ...
        <div className="space-y-2.5">
          <a href={`tel:${member.phone.replace(/\s/g, "")}`} className="flex items-center gap-2.5 text-white hover:text-white/80 transition-colors">
            <div className="w-7 h-7 rounded-full bg-white/20 flex items-center justify-center shrink-0"><Phone className="h-3.5 w-3.5" /></div>
          ...
          <a href={`mailto:${member.email}`} className="flex items-center gap-2.5 text-white hover:text-white/80 transition-colors">
            <div className="w-7 h-7 rounded-full bg-white/20 flex items-center justify-center shrink-0"><Mail className="h-3.5 w-3.5" /></div>
            <span className="text-xs font-medium break-all">{member.email}</span>
          </a>
          <div className="flex items-center gap-2.5 text-white/80">
            <div className="w-7 h-7 rounded-full bg-white/20 flex items-center justify-center shrink-0"><MapPin className="h-3.5 w-3.5" /></div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-16 items-start">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              { v: "4", l: "brokeri dedicați" },
              { v: "11", l: "bănci partenere" },
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-6">
              <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 rounded-lg bg-[#C49A20]/20 flex items-center justify-center">
                  <FileText className="h-4 w-4 text-[#C49A20]" />
                </div>
                <span className="text-xs font-bold text-[#C49A20] uppercase tracking-wider">Operator</span>
              </div>
              <p className="text-white font-semibold text-sm mb-1">Alexandra Achim PFA</p>
              <p className="text-gray-400 text-xs mb-3">CUI · 54405887</p>
              <div className="space-y-1.5 text-xs text-gray-400">
                <p>Înregistrată la Registrul Comerțului</p>
                <p>Autorizată ASF ca intermediar de credite</p>
                <p>Membră ARBC — Asociația Română a Brokerilor de Credite</p>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xs font-bold text-gray-300 uppercase tracking-wider">Sediu înregistrat</span>
              </div>
