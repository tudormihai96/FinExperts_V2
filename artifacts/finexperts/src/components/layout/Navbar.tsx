...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full">
      {/* Top info bar */}
      <div className="bg-[#0A1A2E] text-white text-xs px-4 py-2">
      ...
      <div className="bg-[#F7F4EC] border-b border-[#E5E3D9]">
        <div className="max-w-7xl mx-auto px-4 h-[72px] flex items-center justify-between">
          ...
          {/* Mobile menu button */}
          <button
            className="lg:hidden p-2 text-[#0A1A2E]"
        ...
        {/* Mobile menu */}
        {mobileOpen && (
          <div className="lg:hidden border-t border-[#E5E3D9] bg-[#F7F4EC] px-4 py-4 space-y-1">
            {navLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
